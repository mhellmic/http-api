...
curl -u testname:testpass -H 'accept: application/cdmi-container' -H 'X-CDMI-Specification-Version: 1.0.2' http://localhost:5000/tmp/http_server/testfile
...
# 10. Look at the request from the command line
curl -u testname:testpass -H 'accept: application/json'  http://localhost:5000/request/REQUESTID
