...
class HttpApiTestCase(unittest.TestCase):
    ...
    def __create_container(self, path):
        ...
        conn.request('PUT', ('/' + app.config['RODSZONE'] + '/home/' + app.config['USERNAME'] + path),
    ...
    def __read_container(self, path):
        ...
        self.assertIsNot(body['objectType'], 'application/cdmi-container',
    ...
    def test_create_read_delete_container(self):
        self.__create_container('test_container')
        self.__read_container('test_container')
        self.__delete_object('test_container')

    def test_create_read_delete_file(self):
        self.__create_file('test_file')
        self.__read_file('test_file')
        self.__delete_object('test_file')
